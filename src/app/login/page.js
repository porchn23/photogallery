...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-[#09090b] flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md space-y-12 bg-white dark:bg-zinc-900 p-12 rounded-[4rem] shadow-xl border border-zinc-100 dark:border-zinc-800 text-center">
        ...
        <button 
          ...
          className="w-full py-5 bg-white dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 font-semibold rounded-3xl border border-zinc-200 dark:border-zinc-700 flex items-center justify-center gap-4 hover:bg-zinc-50 transition-all shadow-sm disabled:opacity-50"
        >
